 ...
 * Object validator.
 *
 * @property int        $minProperties Minimum number of properties
 * @property int|null   $maxProperties Minimum number of properties
 * @property string[]       $required Required properties keys
 * @property object $properties Properties
 * @property object|bool|null $additionalProperties
 *
...
class ObjectValidator extends \Phramework\Validate\BaseValidator
{
     ...
     * @param object|bool|null $additionalProperties
